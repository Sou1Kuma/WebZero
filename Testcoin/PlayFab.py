...
def Search_name(query, orderBy, select, top, skip, search_type, search_term=None):
    ...
    elif search_type == "texture":
        filter_query += f" and {tags_filter['texture']}"
    elif search_type == "mashup":
        filter_query += f" and {tags_filter['mashup']}"
    elif search_type == "addon":
        filter_query += f" and {tags_filter['addon']}"
    elif search_type == "persona":
        filter_query = tags_filter['persona']
        search_query = search_term
    elif search_type == "capes":
        filter_query = tags_filter['capes']
    elif search_type == "worldtemplate":
        filter_query += " and tags/any(t: t eq 'worldtemplate')"
    # else: keep base_filter
